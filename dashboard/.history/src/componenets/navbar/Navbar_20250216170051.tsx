...
import { useRouter } from 'next/navi';  // Correct import from 'next/router'
...
const Navbar = () => {
  ...
  if (!isClient || !router.isReady) {
    return null; // return null while waiting for the client-side execution and router to be ready
  }
