      ...
      <Box sx={{ height: "100%", width: 250, padding: 2, backgroundColor: "#212529", borderRadius: 5, margin: 1 }}>
        ...
        <List>
          {menuItems.map((item, index) => {
            ...
            const isSectionOpen = openSections[item.title] || item.subItems?.some((sub) => pathname === sub.path);
              ...
              <div key={index}>
                {item.subItems ? (
                  <>
                    <ListItemButton
                      sx={{
                        backgroundColor: isSectionOpen ? item.color : "transparent",
                        borderRadius: "10px",
                        marginBottom: 1,
                        color: "white",
                      }}
                        ...
                        {item.subItems.map((subItem, subIndex) => {
                          ...
                          return (
                            <ListItemButton
                              ...
                              sx={{
                                pl: 4,
                                backgroundColor: isSubActive ? item.color : "transparent",
                                borderRadius: isSubActive ? "0px" : "10px",
                                marginBottom: 1,
                                color: "white",
                              }}
