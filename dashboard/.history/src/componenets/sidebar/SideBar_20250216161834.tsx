...
const menuItems = [
  ...
  },
  {
    title: "Parcel",
    subItems: [
      { title: "Statistique", path: "/parcel/statistical" },

      { title: "Exchange List", path: "/parcel/exchangeList" },
      { title: "Search", path: "/dashboard/parcel/parcelReturn" },
  ...
  },
  {
    title: "Management",
    subItems: [
      { title: "Delivery Company", path: "/manegement/deliveryCompany" },
      ...
      <Box sx={{ height: "100%", width: 250, padding: 2, backgroundColor: "#212529", borderRadius: 5, margin: 1 }}>
        ...
        <List>
          {menuItems.map((item, index) => {
            const isParentActive = item.subItems?.some((subItem) => pathname === subItem.path);
                ...
                {item.subItems ? (
                      ...
                      <List component="div" disablePadding>
                        {item.subItems.map((subItem, subIndex) => (
                          <ListItemButton
                            ...
                            sx={{
                              pl: 4,
                              backgroundColor: pathname === subItem.path ? item.color : "transparent",
                              borderRadius: pathname === subItem.path ? "10px" : "0px",
                              marginBottom: 1,
                              color: pathname === subItem.path ? "white" : "#ccc",
                            }}
                  ...
                  <ListItemButton
                    sx={{
                      ...
                      borderRadius: pathname === item.path ? "10px" : "0px",
                      marginBottom: 1,
