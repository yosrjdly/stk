...
const TopSellingCard = () => {
  return (
    <Card sx={{ width: 400, borderRadius: 2, boxShadow: 3, overflow: "hidden", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", position: "relative" }}>
      <CardContent sx={{ backgroundColor: "#f57c00", color: "white", textAlign: "center", padding: 2, width: 350, position: "absolute", top: -30 }}>
