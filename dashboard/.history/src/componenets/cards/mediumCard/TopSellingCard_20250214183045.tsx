...
const TopSellingCard = () => {
  return (
    <Card sx={{ width: 500, borderRadius: 5, boxShadow: 3, overflow: "visible", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", position: "relative" }}>
