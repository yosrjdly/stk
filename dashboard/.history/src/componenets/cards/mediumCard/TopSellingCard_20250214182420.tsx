...
const TopSellingCard = () => {
  return (
    <Card sx={{ width: 400, borderRadius: 2, boxShadow: 3, overflow: "visible", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", position: "relative" }}>
      <CardContent sx={{ backgroundColor: "#f57c00", color: "white", textAlign: "center", padding: 2, width: 350, position: "absolute", top: -10,borderRadius: 2 }}>
      ...
      <CardContent sx={{ width: 350, marginTop: 80 }}>
